import { ComputeProgressForDateUseCase, GoalsNotFoundError } from "../application/usecases/ComputeProgressForDateUseCase"
...
class MockNutritionReadRepository implements NutritionReadRepository {
  private entries: Map<string, Array<{
    calories: number
    protein: number
    carbs: number
    fat: number
  ...
  setEntriesForDate(dateISO: string, entries: Array<{
    calories: number
    protein: number
    carbs: number
    fat: number
  ...
  async listFoodEntriesForDate(dateISO: string): Promise<Array<{
    calories: number
    protein: number
    carbs: number
    fat: number
