...
describe('ScoreCalculator', () => {
  ...
  it('classifies candidate names by generic semantic class', () => {
    expect(classifyCandidateSemanticClass('Tomatoes, raw', 'USDA')).toBe('plain_raw');
    expect(classifyCandidateSemanticClass('Tomatoes, scalloped', 'USDA')).toBe('prepared_complex');
    expect(classifyCandidateSemanticClass('Tomato soup', 'USDA')).toBe('composite_dish');
    expect(classifyCandidateSemanticClass('Banana chips', 'USDA')).toBe('prepared_complex');
    expect(classifyCandidateSemanticClass('Apple pie', 'USDA')).toBe('composite_dish');
  });
