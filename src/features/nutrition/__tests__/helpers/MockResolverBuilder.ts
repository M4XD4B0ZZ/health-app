...
export class MockResolverBuilder {
   ...
   */
  withAcceptedFood(input: string, foodName: string, macros: {
    kcal: number;
    protein: number;
    carbs: number;
    fat: number;
  ...
  static createHappyPathResolver(): FoodCatalogResolver {
    return new MockResolverBuilder()
      // Chicken variations
      .withAcceptedFood('chicken', 'Chicken Breast', { kcal: 165, protein: 31, carbs: 0, fat: 3.6 })
      .withAcceptedFood('200g chicken', 'Chicken Breast', { kcal: 165, protein: 31, carbs: 0, fat: 3.6 })
      .withAcceptedFood('250g chicken', 'Chicken Breast', { kcal: 165, protein: 31, carbs: 0, fat: 3.6 })
      .withAcceptedFood('250g chicken breast', 'Chicken Breast', { kcal: 165, protein: 31, carbs: 0, fat: 3.6 })
