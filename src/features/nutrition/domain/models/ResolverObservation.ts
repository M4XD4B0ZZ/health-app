...
export const RESOLVER_OBSERVATION_FIELD_CLASSIFICATIONS = {
  ...
  observationId: 'non_personal_operational',
  resolverRunId: 'non_personal_operational',
  occurredAt: 'non_personal_operational',
  input: 'private_raw',
  ...
  decision: 'non_personal_operational',
  'decision.outcome': 'non_personal_operational',
  'decision.reasonCodes': 'non_personal_operational',
  ...
  versions: 'non_personal_operational',
  'versions.resolverVersion': 'non_personal_operational',
  operational: 'non_personal_operational',
