  ...
  return (
    <ScreenContainer>
      ...
      <View style={styles.transcriptBox}>
        <AppText variant="body" tone={transcribedText ? 'primary' : 'muted'}>
      ...
      <View style={styles.actionsBox}>
        <IconButton icon="close" onPress={handleCancel} disabled={status === 'processing'} />
        <IconButton
          icon="mic"
      ...
      {status !== 'idle' && <InlineStatus state={status} message={statusMessage} />}
